...
class viewRegistrarCompra
{
        ...
        public function montar()			//Por fim imprime o conteudo de $variavel
        {
			...
			{
				$dados[] = '<span style="margin:10px;">'.$valor.'</span>'; //passa cada valor como um item de array
			}		
			...
			include 'fopen_puxarView_compra.php';	//carrega um .html como string na variavel '$paginaHtml' para ser manipulado pela view 
